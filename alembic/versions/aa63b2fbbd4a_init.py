...
Revision ID: aa63b2fbbd4a
Revises: 
Create Date: 2023-02-25 05:01:04.334950
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['group_id'], ['groups_st.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
